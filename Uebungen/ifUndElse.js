console. log ("Übungen zu If-Elsa")
console.log ("====================")

console.log("Übung 1 - Prüfung auf Wert-Gleichheit")

// EXCEL: A1:1 Der Wert 1 wird in Zelle A1 getippt
// B1:2 Der Wert 2 wird in Zelle B1 getippt
 // C1: =wenn(A1=B1; "gleich"; "ungleich")

 // JAVASCRIPT:

let a1 = 3  // Eine Variable (z. B. a1 oder zahl1) wird mit dem Wert 1 initialisiert (zugewiesen)
let b1= 4 // Eine Variable (z.B. b1 oder zahl2) wird mit dem Wert 2 initialisiert
 
if (a1==b1){ // ""=="" um etwas zu vergleichen
    ...
    let a2 = "1" // Eine Variable bekommt zugewiesen Wert 1 // Die Variable a2 wird mit dem Text 1 initialisiert
    let b2 = 1   // Die Variable b2 wird mit der Zahl 1 initialisiert 

    if(a2 === b2) { // "===" prüft Wert und Typ auf Gleichheit
        console.log("a2 und b2 sind gleich.")
    }else{
        console.log("a2 und b2 sind nicht gleich.")
    }

    // Erkentnisgewinn: Mit dem einfachen Gleichheitsszeichen wird ein Wert von rechts nach 
    // zugewiesen. Mit dem doppelten Gleichheitszeichen werden zwei Werte auf Wert-Gleichheit
    // geprüft. Mit dem dreifachen Gleichheitszeichen werden zwei Werte auf Wert und Typ-Gleicheit 
    //geprüft.
    ...
    if (a4 == b4){
        console.log ("a4 und b4 sind gleich")
    }else{
        console.log ("a4 und b4 sind nicht gleich")
    }
